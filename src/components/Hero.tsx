...
const STACK_TAGS = ['Java', 'React', 'Python', 'Flask', 'SQL', 'REST APIs', 'OOP', 'DBMS'];
      ...
      <div className="relative z-10 flex flex-col flex-1 w-full pl-[clamp(1rem,4vw,5rem)] pr-[clamp(1rem,4vw,5rem)] lg:pr-[clamp(1rem,8vw,14rem)]">
        ...
        <div className="flex flex-col flex-1 justify-end pb-[clamp(2.5rem,6vw,6rem)]">
          ...
          >
            ...
            >
              Bangalore, Karnataka, India · Open to Opportunities
            </span>
          </motion.div>
          ...
          >
            <span ref={line1Ref} className="block cursor-default select-none">Rakesh</span>
            <span ref={line2Ref} className="block cursor-default select-none">K</span>
          </h1>
