        ...
        <div className="relative z-10 max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] pt-[clamp(5rem,10vw,11rem)] pb-0">
          ...
          <div className="mb-[clamp(3rem,6vw,8rem)]">
            ...
            <div className="overflow-hidden mb-8">
              <a
                ref={emailRef}
                href="mailto:rakesh160982@gmail.com"
          ...
          {/* Info strip */}
          <motion.div
            className="grid grid-cols-1 sm:grid-cols-4 gap-0 border-t border-white/8 mb-0"
            initial={{ opacity: 0 }}
          ...
          >
            {[
              ...
              { label: 'Email', value: 'rakesh160982@gmail.com' },
              { label: 'Phone / WhatsApp', value: '+91 8431486967' },
          ...
          <div className="relative z-10 max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] py-[clamp(3rem,5vw,5rem)]">
            ...
            >
              <p
                ...
                style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
              >
                © 2026 Rakesh K · Full-Stack & AI Systems Developer, Bangalore, India
              </p>
              <p
                className="text-[0.55rem] tracking-[0.14em] uppercase text-white/12 text-center sm:text-right"
                style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
              >
                Designed &amp; Developed by Rakesh K
              </p>
            </motion.div>
