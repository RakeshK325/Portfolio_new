...
const EXPERIENCE = [
  {
    ...
    company: 'Hackathon & Project Engineering',
    type: 'Student · Project-based',
    bullets: [
      'No formal company employment listed yet; experience is demonstrated through hackathon build sprints and end-to-end project engineering.',
      'Built full-stack applications with React, Next.js, Node.js, Flask, MongoDB, Firebase Firestore, and REST APIs.',
      'Integrated AI and LLM capabilities using Gemini, Google Genkit, and machine-learning workflows for practical product features.',
    ],
    stack: ['Java', 'React', 'Python', 'Node.js', 'MongoDB', 'Gemini'],
  },
]
...
export function Experience() {
  ...
  const Header = (
    <div className="px-[clamp(1.25rem,5vw,5rem)] pt-[clamp(4rem,8vw,10rem)] pb-[clamp(2rem,4vw,4rem)]">
      ...
      >
        {(['Project', 'Work'] as const).map((word, i) => (
