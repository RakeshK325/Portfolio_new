        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[clamp(3rem,6vw,8rem)]">
          ...
          <div className="flex flex-col justify-between gap-10">
            ...
            >
              ...
              >
                A Computer Science and Engineering student based in Bangalore, Karnataka, India, with hands-on experience building full-stack applications and AI-integrated systems through academic and personal projects. I am focused on developing reliable, practical software with a strong foundation in software engineering principles.
              </p>
              <p
              ...
              >
                Core: Java, React, Python, Flask, SQL, REST APIs, OOP, and DBMS. I am passionate about cloud-native integration, modern web technologies, and building enterprise software solutions that solve real problems.
              </p>
              ...
              >
                <a
                  href="https://github.com/RakeshK325"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/rakesh-k325/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[0.65rem] tracking-[0.18em] uppercase font-medium text-black/40 hover:text-black border-b border-black/20 hover:border-black pb-px transition-colors"
                  style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center bg-[#0a0a0a]">
                <RKMark size="lg" theme="dark" />
              </div>
              <div className="absolute inset-0 mix-blend-screen bg-cyan-400/5" />
            </div>
          </div>
        </div>
      </div>
