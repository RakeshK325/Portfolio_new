...
const SUGGESTION_POOL: Suggestion[] = [
  { label: 'What can Rakesh build?',   query: 'What full-stack web applications can Rakesh K build?' },
  { label: 'What is his stack?',       query: 'What technologies and tools does Rakesh K use?' },
  { label: 'AI & LLM integration?',    query: 'How does Rakesh K use Gemini, Genkit, and machine-learning models?' },
  { label: 'See his projects?',        query: 'What are Rakesh K’s three major full-stack and AI projects?' },
  { label: 'Backend systems?',          query: 'What REST API and backend systems can Rakesh K develop?' },
  { label: 'Hackathon experience?',    query: 'What experience does Rakesh K have from hackathons and project build sprints?' },
  { label: 'MERN or Next.js?',         query: 'Can Rakesh K build MERN and Next.js applications?' },
  { label: 'Database experience?',     query: 'Which databases does Rakesh K work with?' },
  { label: 'What is Target-X?',         query: 'What is Rakesh K’s Target-X CRISPR target analysis platform?' },
];
