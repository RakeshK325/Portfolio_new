...
const WORDS = [
  ...
  'HTML5',       'CSS3',         'REST APIs',      'MySQL',
  'MongoDB',     'Firestore',    'Git',            'Docker',
  'Kubernetes',  'DSA',          'OOP',            'DBMS',
  'Gemini',      'Genkit',       'Machine Learning','Full Stack',
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Full-stack applications, backend systems, and AI integrations built with<br />a practical, modern technology stack.
        </motion.p>
        ...
        >
          {[
            { target: 2,  label: 'Project Years' },
            { target: 3, label: 'Major Projects' },
            { target: 20, label: 'Core Skills' },
          ].map((stat, idx) => (
