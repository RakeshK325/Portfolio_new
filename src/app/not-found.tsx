...
import { RKMark } from '@/components/RKMark';
...
export default function NotFound() {
  ...
  return (
    <main className="relative w-full min-h-screen bg-white overflow-hidden flex flex-col">
      ...
      >
        {/* Logo */}
        <Link href="/" aria-label="Rakesh K" className="opacity-45 hover:opacity-80 transition-opacity duration-300">
          <RKMark size="sm" />
        </Link>
      ...
      >
        <span
          ...
          style={{ fontFamily: 'Satoshi, system-ui, sans-serif' }}
        >
          © 2026 Rakesh K · Full-Stack & AI Systems Developer
        </span>
        <span
